const CORE_MODULES = [
  {
    ...
    "videoBrief": {
      ...
      "items": [
        ...
        "Présentez en trois temps : contexte, message principal, conclusion.",
        "Filmez en plan fixe, en une seule prise acceptable, sans chercher à tout recommencer.",
        "Gardez la vidéo : elle servira à comparer vos progrès à la fin du parcours."
      ]
    },
    "sourceMaterials": [
      "Vidéo de départ",
    ...
    "exercise": {
      ...
      "steps": [
        "Choisissez un sujet simple et réel : une idée, un projet, une expérience, une offre ou un sujet que vous pourriez vraiment présenter.",
        "Notez le public auquel vous parlez, votre message principal et votre phrase de fin.",
    ...
    "validationConfirmation": "Je confirme avoir enregistré ma vidéo de départ, complété ma fiche et choisi mon axe prioritaire.",
    "observableCriteria": [
      ...
      "sections": [
        ...
        },
        {
          ...
          "prompts": [
            ...
            "Ce qui reste confus",
            "Ce que je veux rendre plus clair"
          ]
        },
        {
          "title": "Point de départ",
          "prompts": [
            "Mon niveau de trac avant de parler",
            "Le signe de trac le plus visible",
            "Mon axe prioritaire pour la suite"
          ]
        }
      ]
    },
  ...
  },
  {
    ...
    "videoBrief": {
      ...
      "items": [
        "Reprenez le même sujet que la vidéo de départ ou choisissez une situation réelle plus utile maintenant.",
        "Utilisez votre fiche finale : objectif, public, message central, structure, introduction et conclusion.",
        "Filmez en une prise de 3 à 5 minutes pour observer la clarté, la structure, le rythme et la présence.",
        "Comparez avec la vidéo de départ sans chercher la perfection.",
        "Notez trois progrès visibles et un prochain contexte où réutiliser la méthode : réunion, présentation longue, atelier ou conférence."
      ]
    },
    "sourceMaterials": [
      "Exercice n°50 — Répétition générale",
    ...
    "validationConfirmation": "Je confirme avoir enregistré ma vidéo finale, comparé avec la vidéo de départ et écrit mon prochain pas.",
    "observableCriteria": [
...
const BONUS_ITEMS = [
  {
    ...
    "simpleTip": "Allongez légèrement l’expiration : inspirez naturellement, puis soufflez plus lentement que vous n’inspirez.",
  ...
  },
  {
    ...
    "simpleTip": "Parlez vers une personne imaginaire placée au fond de la salle, avec une phrase courte et bien articulée.",
  ...
  },
  {
    ...
    "simpleTip": "Posez les deux pieds au sol, relâchez les épaules et gardez les mains disponibles au lieu de les bloquer.",
    "shortExercise": "Testez trois positions debout. Gardez celle où vous respirez le plus facilement et dites votre message central.",
    "action": "Au début de votre prochain oral, installez cette posture avant de prononcer la première phrase.",
    "reminder": "La posture sert à vous stabiliser, pas à fabriquer une image parfaite."
  },
  {
    "id": "gerer-un-blanc",
    "title": "Gérer un blanc",
  ...
  {
    "id": "mots-parasites",
    "title": "Réduire les mots parasites",
    "duration": "10 à 15 minutes",
    "objective": "Remplacer quelques mots parasites par des pauses utiles.",
    "simpleTip": "Ne cherchez pas à tout enlever. Repérez un seul mot parasite fréquent et remplacez-le par une respiration.",
    ...
    "action": "Choisissez un mot à surveiller pendant votre prochaine répétition, pas plus.",
  ...
  },
  {
    ...
    "duration": "10 à 15 minutes",
    "objective": "Utiliser un support comme appui, sans le transformer en texte à lire.",
...
module.exports = { BONUS_ITEMS, CORE_MODULES };
